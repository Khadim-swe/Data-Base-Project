  ...
  <form method="post">
    ...
    <div class="detail">
        <p>Lorem ipsum dolor sit amet consectetur
             adipisicing elit. Repellat ipsa nihil 
             quam deleniti facilis unde architecto
              quaerat odit sed excepturi?</p>

      
              
    </div>
<input type="hidden" name="product-id" value="<?php echo $fetch_products['id'] ?>">
<div class="button">
    <button type="submit"name="add_to_wishlist" class="btn">add to wishlist <i class="bx bx-heart"></i></button>
    <input type="hidden" name="qty" value="1" min="0" class="quantity">
    <button type="submit"name="add_to cart" class="btn">add to cart <i class="bx bx-cart"></i></button>
